...
<body style="background-color: #ffffff;">
    ...
    <div class="container m-4 mx-auto">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <h3 class="m-0">Detail Pesanan</h3>
        ...
        <?php
            ...
            $sqlData = "SELECT t.lokasi, t.metode_pembayaran, u.nama
                FROM transaksi t
        ...
        <div class="mb-2 p-2 px-3 d-flex flex-row justify-content-between border rounded shadow-sm">
            <div>
                <h5 class="m-0 col">Lokasi Pengiriman</h5>
            ...
            <div>
                <h5 class="m-0 col">Metode Pembayaran</h5>
                <p class="p-0 m-0 col"><?=$d['metode_pembayaran']?></p>
            </div>
        </div>
